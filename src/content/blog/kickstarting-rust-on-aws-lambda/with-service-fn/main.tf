...
resource "aws_iam_role" "lambda_execute_role" {
  ...
  name               = "kickstarting-rust-on-aws-lambda-with-service-fn-execute-role"
}
...
data "archive_file" "bootstrap" {
  type        = "zip"
  source_dir  = "target/lambda/with-service-fn"
  output_path = "dist/with-service-fn.zip"
}
...
resource "aws_lambda_function" "this" {
  function_name = "kickstarting-rust-on-aws-lambda-with-service-fn"
...
resource "aws_iam_policy" "public_invoke" {
  ...
  name   = "kickstarting-rust-on-aws-lambda-with-service-fn-execute-policy"
}
